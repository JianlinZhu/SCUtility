...
{
	[self setForegroundColor:MakeColor(255,  0,  0) backgroundColor:nil forFlag:LOG_FLAG_ERROR];//MakeColor(214,  57,  30)
	[self setForegroundColor:MakeColor(204, 121,  32) backgroundColor:nil forFlag:LOG_FLAG_WARN];
	[self setForegroundColor:MakeColor(0, 0,  255) backgroundColor:nil forFlag:LOG_FLAG_INFO];
}
